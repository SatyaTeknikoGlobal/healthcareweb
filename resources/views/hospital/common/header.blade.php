...
$image_name = Auth::guard('hospital')->user()->image;
                ...
                <div class="navbar-header">
                    <a class="navbar-brand" href="{{route('hospital.home')}}">
                        ...
                        <!-- Logo text --><span>
                         ...
                         <!-- Light Logo text -->    
                         <!-- <img src="{{asset('public/assets/images/logo-light-text.png')}}" class="light-logo" alt="homepage" /></span> -->
                ...
                <div class="navbar-collapse">
                    ...
                    <ul class="navbar-nav my-lg-0">
                        ...
                        <li class="nav-item dropdown u-pro">
                            <a class="nav-link dropdown-toggle waves-effect waves-dark profile-pic" href="#" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><img src="{{asset('public/assets/images/users/1.jpg')}}" alt="user" class=""> <span class="hidden-md-down">{{Auth::guard('hospital')->user()->name ?? ''}} &nbsp;<i class="fa fa-angle-down"></i></span> </a>
                            <div class="dropdown-menu dropdown-menu-end animated flipInY">
                                <!-- text-->
                                <a href="{{ route('hospital.profile') }}" class="dropdown-item"><i class="ti-user"></i> My Profile</a>
                                <!-- text-->
                                ...
                                <div class="dropdown-divider"></div>
                                <!-- text-->
                                <a href="{{ route('hospital.logout') }}" class="dropdown-item"><i class="fa fa-power-off"></i> Logout</a>
                                <!-- text-->
                            </div>
                        </li>
                        <!-- ============================================================== -->
...
@include('hospital.common.sidebar')
