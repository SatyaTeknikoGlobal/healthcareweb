        ...
        <nav class="sidebar-nav">
            ...
            @endif
                ...
                @if(CustomHelper::isAllowedModule('hotels'))
                    ...
                    <li> <a class="waves-effect waves-dark" href="{{ route($ADMIN_ROUTE_NAME.'.hotels.index') }}" aria-expanded="false"><i class="fa fa-hotel" aria-hidden="true"></i><span class="hide-menu">Health Packages</span></a>
                    </li>
                    <?php }?>
                @endif
