        ...
        <div class="row page-titles">
            ...
            <div class="col-md-7 align-self-center text-end">
                <div class="d-flex justify-content-end align-items-center">
                    ...
                    <a href="{{ route($routeName.'.health_packages.add', ['back_url'=>$BackUrl]) }}"><button type="button" class="btn btn-info d-none d-lg-block m-l-15 text-white"><i
                            ...
                            <table id="examplestate" class="table display table-striped border no-wrap">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td><a href="{{route($routeName.'.health_packages.edit', ['id'=>$package->id,'back_url'=>$BackUrl])}}" class="btn btn-primary shadow btn-xs sharp mr-1"><i class="fa fa-pencil"></i></a>
                                            &nbsp;&nbsp;
                                            <a href="{{route($routeName.'.health_packages.delete', ['id'=>$package->id,'back_url'=>$BackUrl])}}" class="btn btn-primary shadow btn-xs sharp mr-1"><i class="fa fa-trash"></i></a>
                                        </td>
...
<script>
    ...
    function change_package_status(package_id,element) {
        ...
        $.ajax({
            url: "{{ route($routeName.'.health_packages.change_package_status') }}",
            type: "POST",
