                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <form method="POST" action="" accept-charset="UTF-8" enctype="multipart/form-data" role="form" class="mt-4">
                            ...
                            <div class="form-group">
                                <label for="exampleInputEmail1" class="form-label">Included Hospital</label>
                                <select class="form-control select2" name="included_hos_ids" data-placeholder="Choose">
                                    <?php if(!empty($hospitals)){
                                        //$included_hos_ids = explode(",",$included_hos_ids);
                                        foreach ($hospitals as $hospital){

                                      ?>
                                <option value="{{$hospital->id}}" <?php if($hospital->id == $included_hos_ids){echo "selected";}?>>{{$hospital->name}}</option>
