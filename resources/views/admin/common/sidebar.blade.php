...
<aside class="left-sidebar">
    ...
    <div class="scroll-sidebar">
        ...
        <nav class="sidebar-nav">
            <ul id="sidebarnav">
                <li class="user-pro"> <a class="has-arrow waves-effect waves-dark" href="javascript:void(0)" aria-expanded="false"><img src="{{asset('public/assets/images/users/1.jpg')}}" alt="user-img" class="img-circle"><span class="hide-menu">Mark Jeckson</span></a>
                ...
                <li> <a class="waves-effect waves-dark" href="{{route('admin.home')}}" aria-expanded="false"><i class="fa fa-tachometer"></i><span class="hide-menu">Dashboard</span></a>
                ...
                if(CustomHelper::isAllowedSection('roles' , $roleId , $type='show') && CustomHelper::isAllowedSection('permission' , $roleId , $type='show') && CustomHelper::isAllowedModule('roles')){?>
                    ...
                    <li> <a class="has-arrow waves-effect waves-dark" href="javascript:void(0)" aria-expanded="false"><i class="ti-layout-grid2"></i><span class="hide-menu">Roles</span></a>
                        <ul aria-expanded="false" class="collapse">
                         ...
                         <li><a href="{{ route($ADMIN_ROUTE_NAME.'.roles.index') }}">Roles</a></li>
                         @endif
                         @if(CustomHelper::isAllowedSection('permission' , $roleId , $type='show'))
                         <li><a href="{{ route($ADMIN_ROUTE_NAME.'.permission.index') }}">Permissions</a></li>
                         @endif
                     </ul>
                 </li>
                ...
                if(CustomHelper::isAllowedSection('states' , $roleId , $type='show') || CustomHelper::isAllowedSection('cities' , $roleId , $type='show') || CustomHelper::isAllowedSection('locality' , $roleId , $type='show')){
                    ...
                    <li> <a class="has-arrow waves-effect waves-dark" href="javascript:void(0)" aria-expanded="false"><i class="mdi mdi-map-marker"></i><span class="hide-menu">Locations</span></a>
                        <ul aria-expanded="false" class="collapse">
                         ...
                         <li><a href="{{ route($ADMIN_ROUTE_NAME.'.cities.index') }}">City</a></li>
                         @endif

                         @if(CustomHelper::isAllowedSection('locality' , $roleId , $type='show'))
                         <li><a href="{{ route($ADMIN_ROUTE_NAME.'.locality.index') }}">Locality</a></li>
                         @endif
                     </ul>
                 </li>
             ...
             <?php  if(CustomHelper::isAllowedSection('categories' , $roleId , $type='show')){?>
                <li> <a class="waves-effect waves-dark" href="{{ route($ADMIN_ROUTE_NAME.'.categories.index') }}" aria-expanded="false"><i class="fa fa-list-alt"></i><span class="hide-menu">Categories</span></a>
            ...
            @endif
                ...
                <?php
                if(CustomHelper::isAllowedModule('admins') || CustomHelper::isAllowedModule('hospitals') || CustomHelper::isAllowedModule('users')){
                ...
                <li> <a class="has-arrow waves-effect waves-dark" href="javascript:void(0)" aria-expanded="false"><i class="mdi mdi-map-marker"></i><span class="hide-menu">User Management</span></a>
                    <ul aria-expanded="false" class="collapse">
                        ...
                        @endif
                        @if(CustomHelper::isAllowedSection('hospitals' , $roleId , $type='show'))
                            <li><a href="{{ route($ADMIN_ROUTE_NAME.'.hospitals.index') }}">Hospitals</a></li>
                        @endif

                        @if(CustomHelper::isAllowedSection('users' , $roleId , $type='show'))
                            <li><a href="{{ route($ADMIN_ROUTE_NAME.'.users.index') }}">Users</a></li>
                        @endif
                    </ul>
                </li>
