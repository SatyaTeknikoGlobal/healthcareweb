...
<head>
    ...
    <!-- page css -->
    <link href="<?php echo e(asset('public/assets/dist/css/pages/login-register-lock.css')); ?>" rel="stylesheet">
    <!-- Custom CSS -->
        ...
        <div class="login-register">
            <div class="login-box card">
                <div class="card-body">
                         ...
                         <form action="<?php echo e(url('admin/login')); ?>" method="post" class="form-horizontal form-material" id="loginform" autocomplete="off">
                                    <?php echo csrf_field(); ?>
...
</html><?php /**PATH /home/appmantr/healthcareweb.appmantra.live/resources/views/admin/login/index.blade.php ENDPATH**/ ?>