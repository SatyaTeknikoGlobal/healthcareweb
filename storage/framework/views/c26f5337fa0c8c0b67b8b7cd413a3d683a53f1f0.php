...
<aside class="left-sidebar">
    ...
    <div class="scroll-sidebar">
        ...
        <nav class="sidebar-nav">
            <ul id="sidebarnav">
                <li class="user-pro"> <a class="has-arrow waves-effect waves-dark" href="javascript:void(0)" aria-expanded="false"><img src="<?php echo e(asset('public/assets/images/users/1.jpg')); ?>" alt="user-img" class="img-circle"><span class="hide-menu">Mark Jeckson</span></a>
                ...
                <li> <a class="waves-effect waves-dark" href="<?php echo e(route('admin.home')); ?>" aria-expanded="false"><i class="fa fa-tachometer"></i><span class="hide-menu">Dashboard</span></a>
                ...
                <?php 
                if(CustomHelper::isAllowedSection('roles' , $roleId , $type='show') && CustomHelper::isAllowedSection('permission' , $roleId , $type='show') && CustomHelper::isAllowedModule('roles')){?>

                    <li> <a class="has-arrow waves-effect waves-dark" href="javascript:void(0)" aria-expanded="false"><i class="ti-layout-grid2"></i><span class="hide-menu">Roles</span></a>
                        <ul aria-expanded="false" class="collapse">
                         <?php if(CustomHelper::isAllowedSection('roles' , $roleId , $type='show')): ?>
                         <li><a href="<?php echo e(route($ADMIN_ROUTE_NAME.'.roles.index')); ?>">Roles</a></li>
                         <?php endif; ?>
                         <?php if(CustomHelper::isAllowedSection('permission' , $roleId , $type='show')): ?>
                         <li><a href="<?php echo e(route($ADMIN_ROUTE_NAME.'.permission.index')); ?>">Permissions</a></li>
                         <?php endif; ?>
                     </ul>
                 </li>
             ...
             <?php 
             if(CustomHelper::isAllowedModule('states') || CustomHelper::isAllowedModule('cities') || CustomHelper::isAllowedModule('locality')){
                if(CustomHelper::isAllowedSection('states' , $roleId , $type='show') || CustomHelper::isAllowedSection('cities' , $roleId , $type='show') || CustomHelper::isAllowedSection('locality' , $roleId , $type='show')){
                    ?>
                    ...
                    <li> <a class="has-arrow waves-effect waves-dark" href="javascript:void(0)" aria-expanded="false"><i class="mdi mdi-map-marker"></i><span class="hide-menu">Locations</span></a>
                        <ul aria-expanded="false" class="collapse">
                         <?php if(CustomHelper::isAllowedSection('states' , $roleId , $type='show')): ?>
                         <li><a href="<?php echo e(route($ADMIN_ROUTE_NAME.'.states.index')); ?>">States</a></li>
                         <?php endif; ?>
                         <?php if(CustomHelper::isAllowedSection('cities' , $roleId , $type='show')): ?>
                         <li><a href="<?php echo e(route($ADMIN_ROUTE_NAME.'.cities.index')); ?>">City</a></li>
                         <?php endif; ?>

                         <?php if(CustomHelper::isAllowedSection('locality' , $roleId , $type='show')): ?>
                         <li><a href="<?php echo e(route($ADMIN_ROUTE_NAME.'.locality.index')); ?>">Locality</a></li>
                         <?php endif; ?>
                     </ul>
                 </li>
             ...
             <?php  if(CustomHelper::isAllowedSection('categories' , $roleId , $type='show')){?>
                <li> <a class="waves-effect waves-dark" href="<?php echo e(route($ADMIN_ROUTE_NAME.'.categories.index')); ?>" aria-expanded="false"><i class="fa fa-list-alt"></i><span class="hide-menu">Categories</span></a>
            ...
            <?php endif; ?>
             ...
             <?php  if(CustomHelper::isAllowedSection('chats' , $roleId , $type='show')){?>
                <li> <a class="waves-effect waves-dark" href="<?php echo e(route($ADMIN_ROUTE_NAME.'.chats.index')); ?>" aria-expanded="false"><i class="fa fa-list-alt"></i><span class="hide-menu">Chats</span></a>
                </li>
            <?php }?>
            <?php endif; ?>
...
<!-- End Sidebar scroll-->
</aside><?php /**PATH /home/appmantr/healthcareweb.appmantra.live/resources/views/admin/common/sidebar.blade.php ENDPATH**/ ?>