                       ...
                       <div class="card-body">
                                ...
                                <input type="hidden" name="id" value="<?php echo e($roles_id); ?>">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Enter Role Name" name="name" value="<?php echo e(old('name', $name)); ?>">
...
</script><?php /**PATH /home/appmantr/healthcareweb.appmantra.live/resources/views/admin/roles/form.blade.php ENDPATH**/ ?>