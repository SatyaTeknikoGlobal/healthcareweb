...
class CustomHelper{
    ...
    public static function isAllowedSection($sectionName , $roleId , $type=''){
        ...
        if($roleId == 0){
           ...
           $sectionpermission = Permission::where('role_id',$roleId)->where('section_name',$sectionName)->first();
...
// echo 'here'; die;
    ...
    public static function UploadFile($file, $path, $ext=''){
        ...
        if(empty($ext)){
            $ext='jpg,jpeg,png,gif,doc,docx,txt,pdf,xls,xlsx';
        }
